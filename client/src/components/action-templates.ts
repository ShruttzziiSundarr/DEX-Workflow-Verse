...
export const ACTION_TEMPLATES = [
  ...
  {
    id: "addLiquidity",
    name: "Add Liquidity (Solana)",
    description: "Add liquidity to a Solana token pair using Raydium or Jupiter on Devnet",
    defaultConfig: {
    ...
    parameterSchema: {
      ...
      amountA: {
        type: "text",
        label: "Amount A",
        description: "Amount of Token A to add (in UI units)",
        placeholder: "0.1",
        required: true,
      },
      amountB: {
        type: "text",
        label: "Amount B",
        description: "Amount of Token B to add (in UI units)",
        placeholder: "10",
        required: true,
      },
      slippageBps: {
